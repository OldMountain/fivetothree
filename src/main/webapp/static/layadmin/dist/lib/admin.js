...
;layui.define("view", function (e) {
    var a = layui.jquery, t = layui.laytpl, i = layui.element, n = layui.setter, l = layui.view, s = layui.device(),
        ...
        g = "layadmin-side-shrink", x = "LAY-system-side-menu", C = {
            v: "1.1.0 pro", req: l.req, sendAuthCode: function (e) {
                ...
                r.off("resize", C.resizeFn[t]), e(), C.resizeFn[t] = e, r.on("resize", C.resizeFn[t])
            }, resizeFn: {}, runResize: function () {
                var e = layui.router(), a = e.path.join("-");
                C.resizeFn[a] && C.resizeFn[a]()
            }, delResize: function () {
                var e = layui.router(), a = e.path.join("-");
                r.off("resize", C.resizeFn[a]), delete C.resizeFn[a]
    ...
    o.on("click", z, function () {
        ...
        return C.tabsPage.type = "tab", C.tabsPage.index = t, "iframe" === e.attr("lay-attr") ? C.tabsBodyChange(t) : (F(e), void C.runResize())
